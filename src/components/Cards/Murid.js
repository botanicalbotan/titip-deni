...
const Store = async (e) => {
 ...
 let NISN= document.getElementById('inputNISN').value
  let NIS= document.getElementById('inputNIS').value
  let nama= document.getElementById('inputNama').value
  let kelas= document.getElementById('kelasmurid').value
 let password=  document.getElementById('inputPassword').value
let alamat= document.getElementById('inputAlamat').value
 let kontak = document.getElementById('inputKontak').value
 let kota_ttl= document.getElementById('inputTTL').value
  //send data to server
  await axios.post('deniex.botanicalbotan.com/api/datamurid/store', {
NISN :NISN,
NIS : NIS,
nama:nama,
kelas:kelas,
...
const [IDAwal, setIDAwal] = useState('');
  ...
  const handleChange = async event => {
   ...
   //fetching
   const responseTipe = await axios.get(`deniex.botanicalbotan.com/api/datamurid/${event.target.value}`);
   //get response data
   const dataTipe = await responseTipe.data.data;
  ...
  const handleChangeupdate = async event => {
    ...
    setSelected(event.target.value);
     //get data from server
     const response = await axios.get(`deniex.botanicalbotan.com/api/datamurid/`);
     //get response data
     const data = await response.data.data
...
<div
        ...
        <div className="rounded-t mb-0 px-4 py-3 border-0">
          <div className="flex flex-wrap items-center">
            <div className="relative w-full px-4 max-w-full flex-grow flex-1">
              ...
              <select name="selectkelasmurid" id="kelasmurid" value={selected} onChange={handleChange}  
                      >
  ...
  return(<>
             ...
             {u.NIS}
                     ...
                     <td>
               <button onClick={() => deletePost(u.NISN)} variant="danger" size="sm">DELETE</button>
              ...
              <div className="flex content-center items-center justify-center h-full">
                    ...
                    <form onSubmit={ Store }>
                                ...
                                <div className="field mt-5">
                                    ...
                                    <input required="required" type="text" className="input" placeholder="" id="inputNISN"/>
                                ...
                                <div className="field mt-5">
                                    ...
                                    <div className="controls">
                                    <input required="required" type="text" className="input" placeholder="" id="inputNIS"/>
                                ...
                                <div className="field mt-5">
                                    ...
                                    <div className="controls">
                                    <input type="text" className="input" placeholder=""id="inputKontak" />
                                    </div>
                                </div><div className="field mt-5">
                                    <label className="label">Tempat Tanggal Lahir</label>
                                    <div className="controls">
                                    <input type="text"  className="input" placeholder=""id="inputTTL" />
                                    </div>
                                </div>
                                <div className="field mt-5">
