      ...
      <div className="flex flex-wrap items-center">
        ...
        <div className="card-body">
          <div className="form-group">
            <input type="text" className="form-control" ref={put_id_mapel} placeholder="id" />
          </div>
          <div className="form-group">
            <input type="text" className="form-control" ref={put_mapel} placeholder="mapel" />
          </div>
          <div className="form-group">
            <input type="text" className="form-control" ref={put_kelas1} placeholder="kelas1" />
          </div>
          <div className="form-group">
            <input type="text" className="form-control" ref={put_kelas2} placeholder="kelas2" />
          </div>
          <div className="form-group">
            <input type="text" className="form-control" ref={put_kelas3} placeholder="kelas3" />
          </div>
          <div className="form-group">
            <input type="text" className="form-control" ref={put_kelas4} placeholder="kelas4" />
          </div>
          <div className="form-group">
            <input type="text" className="form-control" ref={put_kelas5} placeholder="kelas5" />
          </div>
          <div className="form-group">
            <input type="text" className="form-control" ref={put_kelas6} placeholder="kelas6" />
          </div>
          <div className="form-group">
            <input type="text" className="form-control" ref={put_tipe_aka} placeholder="tipe akademik" />
          </div>
